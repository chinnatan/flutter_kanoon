...
import 'package:flutter_pos/core/services/response/refresh_token_rs.dart';
...
abstract class APIAuthService {
  ...
  @POST(APIAuthConst.refreshToken)
  Future<RefreshTokenRs> refreshToken(@Header('Authorization') String refreshToken);
}